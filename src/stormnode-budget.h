...
extern std::map<uint256, CBudgetProposalBroadcast> mapSeenStormnodeBudgetProposals;
extern std::map<uint256, CBudgetVote> mapSeenStormnodeBudgetVotes;
...
//Amount of blocks in a months period of time (using 1.0 minutes per)
    ...
    uint256 GetHash(){
        /* 
            vin is not included on purpose
                - Any stormnode can make a proposal and the hashes should match regardless of who made it. 
