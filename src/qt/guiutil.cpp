...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QTableView { background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px; }"
                      ...
                      "QPushButton    { background: rgb(98,98,98); alternate-background-color: rgb(98,98,98); color: rgb(255,255,255); }"
                      ...
                      "QMenu::item:selected { background-color: rgb(98,98,98); }"
                      ...
                      "QTabBar::tab:selected  { background-color: rgb(98,98,98); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(98,98,98); border-left-style: solid; border-left-width: 6px; }"
                      "QProgressBar   { color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px; }"
                      "QProgressBar::chunk { background: rgb(98,98,98); }"
                      "QTreeView::item { background: rgb(98,98,98); color: rgb(255,255,255); }"
