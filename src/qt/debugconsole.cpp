...
void DEBUGConsole::resizeEvent(QResizeEvent *event)
{
...
void DEBUGConsole::peerSelected(const QItemSelection &selected, const QItemSelection &deselected)
{
    Q_UNUSED(deselected);
...
void DEBUGConsole::peerLayoutChanged()
{
    if (!clientModel)
        return;
...
void DEBUGConsole::updateNodeDetail(const CNodeCombinedStats *stats)
{
...
void DEBUGConsole::setMempoolSize(long numberOfTxs, size_t dynUsage)
{
