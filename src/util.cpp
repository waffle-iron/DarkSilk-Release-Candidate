...
void WriteConfigFile(FILE* configFile)
{
    ...
    fputs ("addnode=159.203.5.23:31000\n", configFile); //TODO (Amir): removed hardcoded Digital Ocean addnode...
    fputs ("addnode=104.215.91.201:31000\n", configFile); //TODO (Amir): removed hardcoded Azure addnode...
    fclose(configFile);
}
