...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"alternate-background-color: rgb(86, 0, 120);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "DarkSilk - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "DarkSilk Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the DarkSilk debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the DarkSilk-Qt help message to get a list with possible DarkSilk command-line options.", 0));
#endif // QT_NO_TOOLTIP
