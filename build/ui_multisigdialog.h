...
public:
    ...
    void retranslateUi(QWidget *MultisigDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        saveRedeemScriptButton->setToolTip(QApplication::translate("MultisigDialog", "The redeem script will be required to spend the funds sent to the multisig address", 0));
#endif // QT_NO_TOOLTIP
        saveRedeemScriptButton->setText(QApplication::translate("MultisigDialog", "Save redeem script", 0));
#ifndef QT_NO_TOOLTIP
        saveMultisigAddressButton->setToolTip(QApplication::translate("MultisigDialog", "Add the multisig address to your personal addresses", 0));
#endif // QT_NO_TOOLTIP
        saveMultisigAddressButton->setText(QApplication::translate("MultisigDialog", "Add address to wallet", 0));
        ...
        label->setText(QApplication::translate("MultisigDialog", "DRKSLK", 0));
        ...
        label_2->setText(QApplication::translate("MultisigDialog", "DRKSLK", 0));
        feeLabel->setText(QApplication::translate("MultisigDialog", "Fee:", 0));
        fee->setText(QApplication::translate("MultisigDialog", "123.456", 0));
        label_3->setText(QApplication::translate("MultisigDialog", "DRKSLK", 0));
