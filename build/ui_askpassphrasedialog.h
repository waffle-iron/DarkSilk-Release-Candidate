...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"alternate-background-color: rgb(0, 0, 0);"));
        ...
        passEdit1->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        passEdit2->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        passEdit3->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
