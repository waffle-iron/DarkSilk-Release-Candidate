...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"alternate-background-color: rgb(0, 0, 0);"));
        ...
        payAmount = new DarkSilkAmountField(SendCoinsEntry);
        payAmount->setObjectName(QStringLiteral("payAmount"));
        payAmount->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        payTo->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
