...
public:
    ...
    void setupUi(QWidget *BlockBrowser)
    {
        ...
        QBrush brush3(QColor(98, 98, 98, 255));
        ...
        txButton->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"alternate-background-color: rgb(86, 0, 120);"));
        ...
        pawBox->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        heightBox->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        blockButton->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"background-color: rgb(86, 0, 120);\n"
"alternate-background-color: rgb(86, 0, 120);"));
        ...
        pawLabel->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        txBox->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
