...
public:
    ...
    void setupUi(QWidget *MessagePage)
    {
        ...
        backButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        ...
        listConversation->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        messageEdit->setStyleSheet(QStringLiteral(" background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        newButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        QIcon icon1;
...
"color: rgb(255, 255, 255);"));
        ...
        copyFromAddressButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        QIcon icon3;
        ...
        copyToAddressButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        ...
        deleteButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        QIcon icon4;
