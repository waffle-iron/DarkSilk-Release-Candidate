...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"alternate-background-color: rgb(0, 0, 0);"));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DRKSLK"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DRKSLK"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DRKSLK"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DRKSLK"));
        ...
        pushButtonSelectAll->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"alternate-background-color: rgb(86, 0, 120);"));
        ...
        treeWidget->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
...
"alternate-background-color: rgb(86, 0, 120);"));
    ...
    void retranslateUi(QDialog *CoinControlDialog)
    {
        ...
        ___qtreewidgetitem->setText(4, QApplication::translate("CoinControlDialog", "Sandstorm Rounds", 0));
