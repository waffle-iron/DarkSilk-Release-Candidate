...
QT_MOC_LITERAL(7, 109, 22), // "sandstormRoundsChanged"
QT_MOC_LITERAL(8, 132, 30) // "anonymizeDarkSilkAmountChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "transactionFeeChanged\0reserveBalanceChanged\0"
    "coinControlFeaturesChanged\0"
    "sandstormRoundsChanged\0"
    "anonymizeDarkSilkAmountChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->sandstormRoundsChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->anonymizeDarkSilkAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::sandstormRoundsChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeDarkSilkAmountChanged)) {
                *result = 5;
            }
        }
    }
...
// SIGNAL 4
void OptionsModel::sandstormRoundsChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 5
void OptionsModel::anonymizeDarkSilkAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
