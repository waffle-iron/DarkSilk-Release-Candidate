...
public:
    ...
    DarkSilkAmountField *transactionFee;
    ...
    DarkSilkAmountField *reserveBalance;
    QSpacerItem *horizontalSpacerReserveBalance;
    QCheckBox *darksilkAtStartup;
    QSpacerItem *verticalSpacer_Main;
    QLabel *label;
    QSpinBox *sandstormRounds;
    QLabel *label_2;
    QSpinBox *AnonymizeDarkSilk;
    QWidget *tabNetwork;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OptionsDialog->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
...
"alternate-background-color: rgb(0, 0, 0);"));
        ...
        tabWidget->setStyleSheet(QStringLiteral("background-color: rgb(0, 0, 0);"));
        ...
        transactionFee = new DarkSilkAmountField(tabMain);
        transactionFee->setObjectName(QStringLiteral("transactionFee"));
        transactionFee->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        reserveBalance = new DarkSilkAmountField(tabMain);
        reserveBalance->setObjectName(QStringLiteral("reserveBalance"));
        reserveBalance->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        darksilkAtStartup = new QCheckBox(tabMain);
        darksilkAtStartup->setObjectName(QStringLiteral("darksilkAtStartup"));

        gridLayout->addWidget(darksilkAtStartup, 4, 0, 1, 1);
        ...
        sandstormRounds = new QSpinBox(tabMain);
        sandstormRounds->setObjectName(QStringLiteral("sandstormRounds"));
        sandstormRounds->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);"));
        sandstormRounds->setMinimum(2);
        sandstormRounds->setMaximum(100);
        sandstormRounds->setValue(4);

        gridLayout->addWidget(sandstormRounds, 6, 1, 1, 1);
        ...
        AnonymizeDarkSilk = new QSpinBox(tabMain);
        AnonymizeDarkSilk->setObjectName(QStringLiteral("AnonymizeDarkSilk"));
        AnonymizeDarkSilk->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);"));
        AnonymizeDarkSilk->setMinimum(2);
        AnonymizeDarkSilk->setMaximum(2000);
        AnonymizeDarkSilk->setSingleStep(10);
        AnonymizeDarkSilk->setValue(1000);

        gridLayout->addWidget(AnonymizeDarkSilk, 7, 1, 1, 1);
        ...
        proxyIp->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"background-color: rgb(0, 0, 0);\n"
"alternate-background-color: rgb(0, 0, 0);\n"
"border-color: rgb(251, 184, 5);"));
        ...
        proxyPort->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"background-color: rgb(0, 0, 0);\n"
"alternate-background-color: rgb(0, 0, 0);\n"
"border-color: rgb(251, 184, 5);"));
        ...
        lang->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        unit->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
...
""));
        ...
        applyButton->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"gridline-color: rgb(251, 184, 5);\n"
"background-color: rgb(86, 0, 120);\n"
"alternate-background-color: rgb(86, 0, 120);\n"
""));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        darksilkAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start DarkSilk after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        darksilkAtStartup->setText(QApplication::translate("OptionsDialog", "&Start DarkSilk on system login", 0));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("OptionsDialog", "<html><head/><body><p>This setting determines the amount of individual Stormnodes that an input will be anonymized through. More rounds of anonymisation gives a higher degree of privacy, but also costs more in fees.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OptionsDialog", "Sandstorm rounds to use", 0));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("OptionsDialog", "This amount acts as a threshold to turn off Sandstorm once it's reached.", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of DRKSLK to keep anonymized", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the DarkSilk client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the DarkSilk network through a SOCKS5 proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting DarkSilk.", 0));
#endif // QT_NO_TOOLTIP
