...
public:
    ...
    QLineEdit *lnMessage;
    QLabel *lblAmount;
    DarkSilkAmountField *lnReqAmount;
    ...
    void setupUi(QDialog *QRCodeDialog)
    {
        ...
        QRCodeDialog->setStyleSheet(QLatin1String("background-color: rgb(0, 0, 0);\n"
...
"alternate-background-color: rgb(0, 0, 0);"));
        ...
        lblQRCode->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"alternate-background-color: rgb(255, 255, 255);\n"
"border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        outUri->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        lnReqAmount = new DarkSilkAmountField(widget);
        lnReqAmount->setObjectName(QStringLiteral("lnReqAmount"));
        lnReqAmount->setEnabled(false);
        lnReqAmount->setMinimumSize(QSize(80, 0));
        lnReqAmount->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
