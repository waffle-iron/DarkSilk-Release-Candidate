...
"color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" color:#ffffff;\">Copyright \302\251 2009-2015 The Bitcoin developers</span></p><p><span style=\" color:#ffffff;\">Copyright (c) 2015 DarkSilk Developers</span></p></body></html>", 0));
