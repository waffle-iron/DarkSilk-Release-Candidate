...
public:
    ...
    void setupUi(QDialog *SendMessagesDialog)
    {
        ...
        SendMessagesDialog->setPalette(palette);
        SendMessagesDialog->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        addressFromLabel->setStyleSheet(QStringLiteral("color: #ffffff;"));
        ...
        addressFrom->setStyleSheet(QStringLiteral("background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        ...
        scrollArea->setStyleSheet(QStringLiteral(" background: rgb(0,0,0); color: rgb(255,255,255); border: 1px inset white; border-radius: 3px; margin: 0px;"));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QStringLiteral("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 304));
        ...
        addButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        ...
        clearButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        QIcon icon3;
        ...
        sendButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        QIcon icon4;
        ...
        closeButton->setStyleSheet(QLatin1String("background-color: rgb(80, 0, 120);\n"
"color: rgb(255, 255, 255);"));
        QIcon icon5;
