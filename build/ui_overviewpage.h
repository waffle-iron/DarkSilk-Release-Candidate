...
public:
    ...
    QFrame *frameSandstorm;
    QWidget *formLayoutWidget;
    QFormLayout *formLayout;
    QLabel *label_6;
    QLabel *label_7;
    QProgressBar *sandstormProgress;
    ...
    QLabel *sandstormEnabled;
    QPushButton *runAutoDenom;
    QPushButton *toggleSandstorm;
    QFrame *lineLastMessage;
    QLabel *sandstormStatus;
    QPushButton *sandstormAuto;
    QPushButton *sandstormReset;
    QWidget *layoutWidget;
    QHBoxLayout *horizontalLayout_5;
    QLabel *label_2;
    QLabel *labelSandStormdSyncStatus;
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelWatchPending->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0.000 DRKSLK"));
        ...
        labelWatchImmature->setText(QStringLiteral("0.000 DRKSLK"));
        ...
        labelImmature->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        labelTotal->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        labelWatchTotal->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        labelBalance->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        labelStake->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        labelWatchStake->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        labelWatchAvailable->setText(QString::fromUtf8("0.000\342\200\211DRKSLK"));
        ...
        frameSandstorm = new QFrame(OverviewPage);
        frameSandstorm->setObjectName(QStringLiteral("frameSandstorm"));
        frameSandstorm->setMinimumSize(QSize(0, 350));
        frameSandstorm->setLayoutDirection(Qt::LeftToRight);
        frameSandstorm->setFrameShape(QFrame::StyledPanel);
        frameSandstorm->setFrameShadow(QFrame::Raised);
        formLayoutWidget = new QWidget(frameSandstorm);
        ...
        sandstormProgress = new QProgressBar(formLayoutWidget);
        sandstormProgress->setObjectName(QStringLiteral("sandstormProgress"));
        sandstormProgress->setMaximumSize(QSize(154, 16777215));
        sandstormProgress->setValue(0);

        formLayout->setWidget(1, QFormLayout::FieldRole, sandstormProgress);
        ...
        labelAnonymized->setText(QStringLiteral("0 DRKSLK"));
        ...
        sandstormEnabled = new QLabel(formLayoutWidget);
        sandstormEnabled->setObjectName(QStringLiteral("sandstormEnabled"));

        formLayout->setWidget(0, QFormLayout::FieldRole, sandstormEnabled);

        runAutoDenom = new QPushButton(frameSandstorm);
        ...
        toggleSandstorm = new QPushButton(frameSandstorm);
        toggleSandstorm->setObjectName(QStringLiteral("toggleSandstorm"));
        toggleSandstorm->setGeometry(QRect(10, 292, 221, 56));
        QSizePolicy sizePolicy1(QSizePolicy::MinimumExpanding, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(toggleSandstorm->sizePolicy().hasHeightForWidth());
        toggleSandstorm->setSizePolicy(sizePolicy1);
        lineLastMessage = new QFrame(frameSandstorm);
        ...
        sandstormStatus = new QLabel(frameSandstorm);
        sandstormStatus->setObjectName(QStringLiteral("sandstormStatus"));
        sandstormStatus->setGeometry(QRect(10, 220, 451, 61));
        sandstormStatus->setMinimumSize(QSize(288, 43));
        sandstormStatus->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        sandstormStatus->setWordWrap(true);
        sandstormAuto = new QPushButton(frameSandstorm);
        sandstormAuto->setObjectName(QStringLiteral("sandstormAuto"));
        sandstormAuto->setGeometry(QRect(230, 292, 221, 28));
        sizePolicy1.setHeightForWidth(sandstormAuto->sizePolicy().hasHeightForWidth());
        sandstormAuto->setSizePolicy(sizePolicy1);
        sandstormReset = new QPushButton(frameSandstorm);
        sandstormReset->setObjectName(QStringLiteral("sandstormReset"));
        sandstormReset->setGeometry(QRect(230, 319, 221, 28));
        sizePolicy1.setHeightForWidth(sandstormReset->sizePolicy().hasHeightForWidth());
        sandstormReset->setSizePolicy(sizePolicy1);
        sandstormReset->setAutoFillBackground(false);
        layoutWidget = new QWidget(frameSandstorm);
        ...
        labelSandStormdSyncStatus = new QLabel(layoutWidget);
        labelSandStormdSyncStatus->setObjectName(QStringLiteral("labelSandStormdSyncStatus"));
        labelSandStormdSyncStatus->setStyleSheet(QStringLiteral("QLabel { color: red; }"));
        labelSandStormdSyncStatus->setText(QStringLiteral("(out of sync)"));
        labelSandStormdSyncStatus->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);

        horizontalLayout_5->addWidget(labelSandStormdSyncStatus);
        ...
        verticalLayout_2->addWidget(frameSandstorm);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
...
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("OverviewPage", "Stake:", 0));
#ifndef QT_NO_TOOLTIP
        ...
        labelAnonymizedText->setText(QApplication::translate("OverviewPage", "SandStorm Balance:", 0));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", 0));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 DRKSLK / 0 Rounds", 0));
        label_9->setText(QApplication::translate("OverviewPage", "Submitted Denom:", 0));
#ifndef QT_NO_TOOLTIP
        labelSubmittedDenom->setToolTip(QApplication::translate("OverviewPage", "The denominations you submitted to the Stormnode.<br>To mix, other users must submit the exact same denominations.", 0));
#endif // QT_NO_TOOLTIP
        labelSubmittedDenom->setText(QApplication::translate("OverviewPage", "n/a", 0));
        sandstormEnabled->setText(QApplication::translate("OverviewPage", "Enabled/Disabled", 0));
        runAutoDenom->setText(QString());
        toggleSandstorm->setText(QApplication::translate("OverviewPage", "Start/Stop Mixing", 0));
        sandstormStatus->setText(QApplication::translate("OverviewPage", "(Last Message)", 0));
#ifndef QT_NO_TOOLTIP
        sandstormAuto->setToolTip(QApplication::translate("OverviewPage", "Try to manually submit a SandStorm request.", 0));
#endif // QT_NO_TOOLTIP
        sandstormAuto->setText(QApplication::translate("OverviewPage", "Try Mix", 0));
#ifndef QT_NO_TOOLTIP
        sandstormReset->setToolTip(QApplication::translate("OverviewPage", "Reset the current status of SandStorm (can interrupt SandStorm if it's in the process of Mixing, which can cost you money!)", 0));
#endif // QT_NO_TOOLTIP
        sandstormReset->setText(QApplication::translate("OverviewPage", "Reset", 0));
        label_2->setText(QApplication::translate("OverviewPage", "SandStorm", 0));
#ifndef QT_NO_TOOLTIP
        labelSandStormdSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Transfer network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("OverviewPage", "Recent transactions", 0));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Transfer network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
