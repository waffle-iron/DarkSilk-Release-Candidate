...
""));
        ...
        labelTotal->setText(QStringLiteral("0 DRKSLK"));
        ...
        frameSandstorm = new QFrame(scrollAreaWidgetContents);
        frameSandstorm->setObjectName(QStringLiteral("frameSandstorm"));
        QSizePolicy sizePolicy(QSizePolicy::MinimumExpanding, QSizePolicy::MinimumExpanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frameSandstorm->sizePolicy().hasHeightForWidth());
        frameSandstorm->setSizePolicy(sizePolicy);
        frameSandstorm->setMinimumSize(QSize(500, 261));
        frameSandstorm->setStyleSheet(QStringLiteral("background:transparent;"));
        frameSandstorm->setFrameShape(QFrame::StyledPanel);
        frameSandstorm->setFrameShadow(QFrame::Raised);
        verticalLayoutWidget = new QWidget(frameSandstorm);
        verticalLayoutWidget->setObjectName(QStringLiteral("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(0, 0, 400, 261));
        ...
        sandstormEnabled = new QLabel(verticalLayoutWidget);
        sandstormEnabled->setObjectName(QStringLiteral("sandstormEnabled"));
        sandstormEnabled->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        sandstormProgress = new QProgressBar(verticalLayoutWidget);
        sandstormProgress->setObjectName(QStringLiteral("sandstormProgress"));
        sandstormProgress->setMaximumSize(QSize(154, 16777215));
        sandstormProgress->setStyleSheet(QStringLiteral("background:transparent;"));
        ...
        labelAnonymizedText->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        labelAnonymized->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        labelAmountRounds->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        labelSubmittedDenom->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        ...
        toggleSandstorm->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"gridline-color: rgb(251, 184, 5);\n"
"background-color: rgb(86, 0, 120);\n"
"alternate-background-color: rgb(86, 0, 120);"));

        horizontalLayout_2->addWidget(toggleSandstorm);

        sandstormReset = new QPushButton(verticalLayoutWidget);
        ...
        sandstormReset->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"gridline-color: rgb(251, 184, 5);\n"
"background-color: rgb(86, 0, 120);\n"
"alternate-background-color: rgb(86, 0, 120);"));

        horizontalLayout_2->addWidget(sandstormReset);

        sandstormAuto = new QPushButton(verticalLayoutWidget);
        ...
        sandstormAuto->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"gridline-color: rgb(251, 184, 5);\n"
"background-color: rgb(86, 0, 120);\n"
"alternate-background-color: rgb(86, 0, 120);"));

        horizontalLayout_2->addWidget(sandstormAuto);


        verticalLayout_5->addLayout(horizontalLayout_2);


        horizontalLayout->addWidget(frameSandstorm);
        ...
        listTransactions->setMinimumSize(QSize(650, 300));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the DarkSilk network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_61->setText(QApplication::translate("OverviewPage", "Status:", 0));
        ...
        labelAnonymized->setText(QApplication::translate("OverviewPage", "0 SILK", 0));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", 0));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 SILK / 0 Rounds", 0));
        label_9->setText(QApplication::translate("OverviewPage", "Submitted Denom:", 0));
#ifndef QT_NO_STATUSTIP
        labelSubmittedDenom->setStatusTip(QApplication::translate("OverviewPage", "Amount submitted to the Stormnode. To mix, other users must submit the exact same denomination(s).", 0));
        ...
        toggleSandstorm->setText(QApplication::translate("OverviewPage", "Start/Stop", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the DarkSilk network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
